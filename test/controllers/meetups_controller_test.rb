...
class MeetupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meetup" do
    assert_difference("Meetup.count") do
      post meetups_url, params: { meetup: { date: @meetup.date, description: @meetup.description, main_image: @meetup.main_image, thumb_image: @meetup.thumb_image, time: @meetup.time, title: @meetup.title } }
    end
  ...
  test "should update meetup" do
    patch meetup_url(@meetup), params: { meetup: { date: @meetup.date, description: @meetup.description, main_image: @meetup.main_image, thumb_image: @meetup.thumb_image, time: @meetup.time, title: @meetup.title } }
